...
if __name__ == "__main__":
    ...
    for Y in range(0,360):         # <<--- mude aqui para diminuir o numero de celulas de grid
        for X in range(0,720):     # <<--- aqui tb. Para Amazônia (ragião de Manaus) ny(140-190), nx(230, 260)
